...
int main(int argc, char *argv[])
{
    ...
    float *triangle = new float[7 * 3 * 4] {
        ...
        -0.5,  0.5, 0.1, 255,   0,   0, 255, 
         0.5,  0.5, 0.1, 255,   0,   0, 255,
         0.0, -0.5, 0.1, 255,   0,   0, 0,
         
        -0.3, -0.3, 0.2,   255, 255,   0, 255, 
         0.3, -0.3, 0.2,   255, 255,   0, 0,
         0.0,  0.3, 0.2,   255, 255,   0, 0,
         
        -0.5, -0.5, 0.5,   0, 255,   0, 255, 
         0.5, -0.5, 0.5,   0, 255,   0, 255,
         0.0,  0.5, 0.5,   0, 255,   0, 255,
         
        -0.5, -0.7, 0.0,   0, 0,   255, 255, 
         0.5, -0.7, 0.0,   0, 0,   255, 0,
         0.0,  0.7, 0.0,   0, 0,   255, 0,
    };
